<%@page import="br.com.relato.extranet.download.SearchDownload"%>
...
<%
			int count = 0;
			List list = SearchDownload.execute(request.getParameter("action"),
...
%>
		...
		var myColumns = [
			"ID", "Login do usuário", "Nome do usuário", "Nome do arquivo", "Data/hora Download"
		];
	</script>
