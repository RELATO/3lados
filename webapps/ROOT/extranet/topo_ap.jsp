...
<!-- *************** TOPO *************** -->
	<tr>
		<td bgcolor="white" valign="top" width="776"><img src="/img/topo.gif"></td>
	</tr>
	<tr>
...
%>
		...
		<a target="_blank" class="menu" href="/siteadmin/email/enviaemail.jsp">Envio de Email</a>
		<a target="_blank" class="menu" href="/siteadmin/home.jsp">Editor de Html</a>
<%
	}
%>
