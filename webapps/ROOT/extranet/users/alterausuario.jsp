...
<%
	...
	criteria.addExpression(SQLExpression.SQL_IGUAL, "idiusuario", request.getParameter("id"));
...
<table border="0" align="center">
		...
		<tr>
			...
			<td>
				<input type="text" name="login" id="login" maxlength="220" style="width: 100px;" value="<%=row.get(3) %>">
			</td>
		</tr>
		<tr>
			<td class="texto">
			...
			<td>
				<input type="text" name="pass" id="pass" maxlength="220" style="width: 100px;" value="<%=row.get(4) %>">
			</td>
		</tr>
		<tr>
			<td class="texto">
			...
			<td>
				<select id="ativo" name="ativo">
				  <option value=""></option>
                  <option value="0" <%="0".equals(String.valueOf(row.get(5))) ? "selected": ""%>>Não</option>
                  <option value="1" <%="1".equals(String.valueOf(row.get(5))) ? "selected": ""%>>Sim</option>
				</select>		
			</td>
		</tr>
		<tr>
			...
			<td>
				<select id="admin" name="admin">
				  <option value=""></option>
                  <option value="0" <%="0".equals(String.valueOf(row.get(6))) ? "selected": ""%>>Não</option>
                  <option value="1" <%="1".equals(String.valueOf(row.get(6))) ? "selected": ""%>>Sim</option>
				</select>		
			</td>
		</tr>
		<tr>	
			...
			<td>
				<select id="publicador" name="publicador">
				  <option value=""></option>
                  <option value="0" <%="0".equals(String.valueOf(row.get(7))) ? "selected": ""%>>Não</option>
                  <option value="1" <%="1".equals(String.valueOf(row.get(7))) ? "selected": ""%>>Sim</option>
				</select>		
			</td>
		</tr>
		<tr>	
			...
			<td>
				<select id="editor" name="editor">
				  <option value=""></option>
                  <option value="0" <%="0".equals(String.valueOf(row.get(8))) ? "selected": ""%>>Não</option>
                  <option value="1" <%="1".equals(String.valueOf(row.get(8))) ? "selected": ""%>>Sim</option>
				</select>		
			</td>
		</tr>
		</table>
