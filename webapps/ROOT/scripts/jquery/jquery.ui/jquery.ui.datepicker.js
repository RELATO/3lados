...
$.extend(Datepicker.prototype, {
	...
	_doKeyUp: function(event) {
		//Function alterada pela Relato para funcionar de acordo com o maskedinput
		var inst = $.datepicker._getInst(event.target);
		if (inst.input.val() != inst.lastVal) {
			try {
				...
				if((inst.input ? inst.input.val().substring((inst.input.val().length-1),(inst.input.val().length)) : "_") != "_" ){
