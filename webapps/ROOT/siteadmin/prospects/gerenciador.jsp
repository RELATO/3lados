...
window.pesquisa = function(){
	...
	iframe.src = "/extranet/prospects/grid.jsp?action="+document.getElementById("operacao").value+
...
function doOpen(action){
	...
	if (action == 1)
		url = "/extranet/prospects/alteracadastro.jsp?id=" + getId()
	else
		url = "/extranet/prospects/novocadastro.jsp"
  ...
  <table style="border: 1px solid #000000; margin: 5px; margin-top: 10px;" width="770" cellpadding="0" cellspacing="0" bgcolor="#EBEADB">
    <tr style="background-color: #000000;"> 
      <td colspan="4" style="border-bottom: 1px solid #000000; padding-bottom: 3px;"><center>
          <strong><font color="#FFFFFF" size="3" face="verdana, verdana, Arial, Helvetica, sans-serif">Gerenciador de Prospects</font></strong>
        </center></td>
    </tr>
    ...
    <tr style="padding-bottom: 5px;"> 
      <td style="padding-left: 8px"><select class="colunaum" id="campo" name="campo">
          ...
          <option value="nmsbairro">Bairro</option>
          <option value="nmscidade">Cidade</option>
          <option value="nmsestado">Estado</option>
          <option value="nmspais">Pais</option>
    ...
    <tr> 
      <td colspan="4" style="border-top: 1px solid #000000;" bgcolor="#EBEADB"> 
        <span > 
        <iframe id="grid" src="/extranet/prospects/grid.jsp" frameborder="0" width="100%" height="238"></iFrame>
        </span> </td>
    </tr>
  </table>
</form>
