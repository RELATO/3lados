...
function chamaUploadMail(){
	//alert('lalala');
	window.open('arquivo_email.jsp?retorno=filename&idjob=1&opcao=M','upload','top=20, left=20, width=526, height=250');
}
...
<form action="/enviaemail" method="post" onSubmit="return getData()" target=_blank>
...
<textarea name="content" id="content" style="display: none;"></textarea>
  <table align="center" bgcolor="#FFFFFF" width="800" cellpadding="0" cellspacing="0" style="border: 1px solid black; border-collapse: collapse; vertical-align: middle;">
    ...
    <tr>
      <td colspan="1" align="right">Arquivo:</td>
      <td colspan="4" align="left">
      	<input class="textfield" type="text" name="filename" id="filename" readonly>
        <input type="button" onClick="chamaUploadMail();" id="upload" name="upload" value="Procurar..." class="botaoesp" onMouseOver="this.className='botaoespover'" onMouseOut="this.className='botaoesp'">	
      </td>
    </tr>
