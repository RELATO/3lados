...
<%
String imagens_dir_path = ConstantsApp.getParametro("enviaemail_imgpath");
String imagens_dir_path_default = ConstantsApp.getParametro("enviaemail_dir_path");
String flash_dir_path = ConstantsApp.getParametro("enviaemail_flashpath");
String dir_path = "";
%>
...
<title>E-mail HTML Editor</title>
<style>
.select{
...
<%
String pathToIncFiles = ConstantsApp.getParametro("enviaemail_pathToIncFiles");
%>

<jsp:useBean id="eeheu" scope="session" class="system.HEUtil">
  <jsp:setProperty name="eeheu" property="pathToIncFiles" value="<%=pathToIncFiles%>"/>
</jsp:useBean>
...
<%
	...
	out.print(eeheu.getTextoInc("find_replace.inc"));
} else if ("SpellCheck".equals(toDo)) {
	out.print(eeheu.getTextoInc("spell_check.inc"));
} else if ("DoSpell".equals(toDo)) {
	out.print(eeheu.getTextoInc("do_spell.inc"));
} else if ("InsertTable".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_table.inc"));
} else if ("ModifyTable".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_table.inc"));
} else if ("ModifyCell".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_cell.inc"));
} else if ("InsertForm".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_form.inc"));
} else if ("ModifyForm".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_form.inc"));
} else if ("InsertTextField".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_textfield.inc"));
} else if ("ModifyTextField".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_textfield.inc"));
} else if ("InsertTextArea".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_textarea.inc"));
} else if ("ModifyTextArea".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_textarea.inc"));
} else if ("InsertHidden".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_hidden.inc"));
} else if ("ModifyHidden".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_hidden.inc"));
} else if ("InsertButton".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_button.inc"));
} else if ("ModifyButton".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_button.inc"));
} else if ("InsertCheckbox".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_checkbox.inc"));
} else if ("ModifyCheckbox".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_checkbox.inc"));
} else if ("InsertSelect".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_select.inc"));
} else if ("ModifySelect".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_select.inc"));
} else if ("InsertRadio".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_radio.inc"));
} else if ("InsertRadio".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_radio.inc"));
} else if ("ModifyRadio".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_radio.inc"));
} else if ("PageProperties".equals(toDo)) {
	out.print(eeheu.getTextoInc("page_properties.inc"));
} else if ("Chars".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_chars.inc"));
} else if ("InsertLink".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_link.inc"));
} else if ("InsertEmail".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_email.inc"));
} else if ("InsertAnchor".equals(toDo)) {
	out.print(eeheu.getTextoInc("insert_anchor.inc"));
} else if ("ModifyAnchor".equals(toDo)) {
	out.print(eeheu.getTextoInc("modify_anchor.inc"));
} else if ("MoreColors".equals(toDo)) {
	out.print(eeheu.getTextoInc("more_colors.inc"));
} else if ("CustomInsert".equals(toDo)) {
	out.print(eeheu.getTextoInc("custom_insert.inc"));
} else if ("ShowHelp".equals(toDo)) {
	out.print(eeheu.getTextoInc("help.inc"));
}
%>
