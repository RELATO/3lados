...
<%
String dir_path = ConstantsApp.getParametro("prospect.documentos");
%>
...
<form method="post" action="upload_arquivo.jsp" name="upform" enctype="multipart/form-data">
...
function retornaValor() {
	...
	var xarq = window.opener.document.getElementById("arquivoMensagem")
	if (null!=xarq) {
