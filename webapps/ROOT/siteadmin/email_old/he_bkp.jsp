...
<body bgcolor="#ffffff" onUnLoad="fechaHE()">
...
<form action="he.jsp" method="post">
      <p><strong>Id:</strong> <input type="text" name="idHE" id="idHE" size="5" value="23" readonly=yes>&nbsp;
	  <strong>Título:</strong> <input type="text" maxlength="255" size="50" name="tituloHE" id="tituloHE" value="">&nbsp;
	  <strong>Tipo:</strong> <select name="tipoHE" id="tipoHE">
    	...
    	<div align="center">
		<input type="button" name="buscaConteudo" id="buscaConteudo" class="botao" value="Busca Conteúdo" onClick="buscaHE()"/>
		<input type="button" name="novoConteudo" id="novoConteudo" class="botao" value="Novo Conteúdo" onClick="insertHE()"/>
      		<input type="button" name="atualizaConteudo" id="atualizaConteudo" class="botao" value="Atualiza Conteúdo" onClick="on_commandHE(1)"/>
	      	<input type="button" name="bExclui" class="botao" value="Exclui Conteúdo" onClick="on_commandHE(2)"/>
	    </div>
      </p>	
...
<textarea style=display:none id='HEControl_src'><link rel="stylesheet" href="he_includes/he_styles.css" type="text/css">
					...
					<iframe onBlur="updateValue()" id=previewFrame height=80% style="width=100%; display:none" style="border: 1px solid #D4D0C8"></iframe>
						...
						<iframe id="HEControl_frame" width="90%" height="80%" frameborder=0 scrolling="no"></iframe>
