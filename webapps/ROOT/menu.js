...
jQuery(function() {
    ...
    $('#menu ul div', '#menu').css('visibility', 'hidden');
		if (!$('#menu li.current').length) $('#menu li:first').addClass('active');     
    $('.menu>li', '#menu').hover(
        function(){
    ...
    $('ul ul li', '#menu').hover(
		...
		if (!($.browser.msie && $.browser.version.substr(0, 1) == '6')) {
	  	$('#menu>ul.menu>li:not(.active)').attr('pos', 1080).attr('iid', 0);
	  	$('#menu>ul.menu>li:not(.active)>a').css('backgroundPosition', 'left -1080px');
	  	$('#menu>ul.menu>li:not(.active)>a>span').css('backgroundPosition', 'right -1125px');
	  }
        ...
        $('ul.menu ul li', '#menu').css('backgroundColor', apycom.colors.submenu.item)
        .hover(
