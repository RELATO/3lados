	...
	function doTextbox() {
		...
		oSel.pasteHTML("<table id=he_textBox style='position:absolute;'><tr><td>Text box</td></tr></table>");

		textBox = foo.document.getElementById("he_textBox")
	...
	function editMe() {
		if (editModeView == false)
		{
			...
			document.getElementById("editTab").src = deveditPath1 + "he_imagens/status_edit_up.gif"
			document.getElementById("sourceTab").src = deveditPath1 + "he_imagens/status_source.gif"
			document.getElementById("previewTab").src = deveditPath1 + "he_imagens/status_preview.gif"
			initFoo()
			foo.focus()
		}
	}
	...
	function sourceMe() {
		if (sourceModeView == false)
		{
			...
			document.getElementById("editTab").src = deveditPath1 + "he_imagens/status_edit.gif"
			document.getElementById("sourceTab").src = deveditPath1 + "he_imagens/status_source_up.gif"
			document.getElementById("previewTab").src = deveditPath1 + "he_imagens/status_preview.gif"
	...
	function previewMe() {
		if (previewModeView == false)
		{
			...
			document.getElementById("editTab").src = deveditPath1 + "he_imagens/status_edit.gif"
			document.getElementById("sourceTab").src = deveditPath1 + "he_imagens/status_source.gif"
			document.getElementById("previewTab").src = deveditPath1 + "he_imagens/status_preview_up.gif"
		}
	}
	...
	function toggleTick(tick, state) {
		...
		if(tick.id.indexOf("zoom" + zoomSize + "_") > -1)
		{
			if(state == 1)
			{
				...
				tick.src = 'de/he_imagens/button_tick_inverted.gif'
			}
			else
			{
				// We are over the selected zoom
				tick.src = 'de/he_imagens/button_tick.gif'
			}
		}
	}
	...
	function doImage() {
		if (isAllowed())
		{
			...
			imageWin = window.open(HTTPStr + '://' + URL + ScriptName + '?ToDo=InsertImage&DEP1='+deveditPath1+'&DEP='+deveditPath + '&imgDir=' + imageDir + '&wi=' + HideWebImage + '&tn=' + showThumbnails + '&du=' + disableImageUploading + '&dd=' + disableImageDeleting + '&dt=' + isEditingHTMLPage,'','width='+widthW+',height='+heightW+',scrollbars=yes,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);

		}
	}

	function template(id){
		window.parent.getTemplate(id);
	}
	...
	function openTemplate() {
		...
		window.open('popup.jsp','Template','width='+widthW+',height='+heightW+',scrollbars=yes,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
	}
	...
	function ShowInsertTable() {
		...
		var topPos = (screen.availHeight-302) / 2 
 		inserttableWin = window.open(HTTPStr + '://' + URL + ScriptName + '?ToDo=InsertTable&DEP1='+deveditPath1+'&DEP='+deveditPath,'','width=450,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
	...
	function ShowFindDialog() {
		if (isAllowed())
		{
		showModelessDialog(HTTPStr + "://" + URL + ScriptName + "?ToDo=FindReplace&DEP1='+deveditPath1+'&DEP="+deveditPath, foo, "dialogWidth:395px; dialogHeight:165px; scroll:no; status:no; help:no;" );
		}
	}
