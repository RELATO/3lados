...
<table align="center" width="800" cellpadding="0" cellspacing="0" style="border: 1px solid white; border-collapse: collapse; vertical-align: middle;">
	<tr>
      <td colspan="5" align="center" style="border: 1px solid white;"><img src="../img/topo_htmleditor.jpg" width="500" height="67"></td>
    </tr>
	<tr bgcolor="3163A0">
		<td width="50" style="padding-left: 10px;"><strong><font size="-2" color="white";>Id</font></strong> </td>
		<td width="200" style="padding-left: 10px; "><strong><font size="-2" color="white">Título</font></strong></td>
...
%>
	...
	<tr style="padding-bottom: 5px; border-bottom: 1px solid white;" bgcolor="#3163A0">		
		<td width="50" style="padding-left: 10px; border-bottom: 1px solid white;"><input style="text-align: right;" type="text" name="idHE" id="idHE" size="5" value="23" readonly=yes></td>
		<td width="200" style="padding-left: 10px; border-bottom: 1px solid white;"><input type="text" maxlength="255" size="50" name="tituloHE" id="tituloHE" value=""></td>
		<td width="82" style="padding-left: 10px; border-bottom: 1px solid white;"> 
			<select name="tipoHE" id="tipoHE">
				<option value="C" <%=tipoConteudo.equals("C") ? "selected" : "" %>>Conteúdo</option>
				<option value="N" <%=tipoConteudo.equals("N") ? "selected" : "" %>>Notícia</option>
				<option value="A" <%=tipoConteudo.equals("A") ? "selected" : "" %>>Agenda</option>
			</select>
		</td>
		
		<input type="hidden" name="linguaHE" id="linguaHE">
		
		<td width="80" style="padding-left: 10px; border-bottom: 1px solid white;">  
<%
	if ( !EntryPoint.isEditor() ){
%>
...
%>		
      ...
      <td align="center" bgcolor="3163A0" style="border: 1px solid white; border-top: none; color: white; padding: 5px;"> 
        <input style="margin-right:5px;" type="button" name="enviaEmail" title="Atualizar conteúdo e envia-lo por e-mail" id="enviaEmail" class="botaoesp" value="Email" onMouseOver="this.className='botaoespover';" onMouseOut="this.className='botaoesp';" onClick="show();"/>	
        <input style="margin-right:5px;" type="button" name="atualizaConteudo" id="atualizaConteudo3" class="botaoesp" value="Atualiza" onMouseOver="this.className='botaoespover';" onMouseOut="this.className='botaoesp';" onClick="on_commandHE(1)"/>	
        ...
        <input type="hidden" name="acao" value="<%=acao%>">
          <input type="hidden" name="id" value="<%=idConteudo%>">
	  </td>
	</tr>
	
	<tr>
		<td colspan = "7"> 
			<div id="camposemail" class="naover" colspan="2">
				<table>
					<tr style="padding-top: 10px; padding-bottom: 5px; border-bottom: 1px solid white;" bgcolor="#3163A0">
				      <td align="right"><strong><font size="-2" color="white";>De:</font></strong></td>
				      <td align="left"><input class="textfield" size="80" type="text" name="fromX"></td>
				    </tr>
					
					<tr style="padding-bottom: 5px; border-bottom: 1px solid white;" bgcolor="#3163A0">
				      <td align="right"><strong><font size="-2" color="white";>Para:</font></strong></td>
				      <td align="left"><input class="textfield" size="80" type="text" name="toX"><strong><font size="-2" color="white";>(Somente para testes)</font></strong></td>
				    </tr>
					
					<tr style="padding-bottom: 5px; border-bottom: 1px solid white;" bgcolor="#3163A0">
				      <td align="right"><strong><font size="-2" color="white";>Assunto:</font></strong></td>
				      <td align="left"><input class="textfield" size="80" type="text" name="subjectX"></td>
				    </tr>
					
					<tr style="padding-bottom: 5px; border-bottom: 1px solid white;" bgcolor="#3163A0" height="30"> 
				      <td colspan= "2" align="center"> 
				        <input type="button" onClick="emailSubmit('send');" name="enviar" value="Enviar" class="botaoesp" onMouseOver="this.className='botaoespover'" onMouseOut="this.className='botaoesp'">
				        <input type="button" onClick="emailSubmit('resend');" name="reenviar" value="Reenviar" class="botaoesp" onMouseOver="this.className='botaoespover'" onMouseOut="this.className='botaoesp'">
				        <input type="button" onClick="emailSubmit('test');" name="teste" value="Teste" class="botaoesp" onMouseOver="this.className='botaoespover'" onMouseOut="this.className='botaoesp'">
				      </td>
				    </tr>
		    	</table>
			</div>
	...
	<tr style="vertical-align: middle">	
		<td colspan="6" height="480" align="center" style="vertical-align: middle; padding-top: 30px;" bgcolor="#3163A0">
		::::::::::::::::
		<textarea style=display:none id='HEControl_src'><link rel="stylesheet" href="he_includes/he_styles.css" type="text/css">
					...
					<script>
							alert(document.getElementById("HEControl_src").value);
							var customInserts = [];
							var customLinks = [];
							var tableDefault = 1;
							var useBR = 0;
					...
					<option value="1">1</option>
			  		...
			  		<option value="7">7</option>
										...
										<td>
										  <img class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this);" onClick="toggleBorders()" onMouseOut="button_out2(this);" type=image width="21" height="20" src="he_imagens/button_show_borders.gif" border=0 title="Mostrar/Ocultar Linhas-Guia" id=guidelines></td>

										<td>
										  <img class=templatebutton onMouseOver="button_over(this);" onClick="openTemplate()" onMouseOut="button_out2(this);" type=image width="21" height="20" src="he_imagens/button_show_borders.gif" border=0 title="inserir modelos de páginas" id=templates></td>										
					...
					<iframe onBlur="updateValue()" id=previewFrame height=80% style="width=100%; display:none" style="border: 1px solid #D4D0C8"></iframe>
        				...
        				<script language="JavaScript">
							...
							function getDataIframe(){
								if ( Mode == "2" )
									return foo.document.body.innerText;
								
								return foo.document.body.innerHTML;
							}
						...
						<script language="JavaScript">
							window.parent.loadedIFrame();
        				</script>
					</textarea>
		</td></tr></table>
	</form>
	
	<form name="formemail" action="/enviaemail" method="post" onSubmit="return getData()" target=_blank>
