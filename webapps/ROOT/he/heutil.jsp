...
<%@page import="br.com.relato.extranet.menu.Menu"%>
<%@page import="br.com.relato.extranet.menu.MenuService"%>
<%@page import="br.com.relato.extranet.menu.MenuRender"%>
...
String imagens_dir_path = ConstantsApp.getParametro("imgpath");
String imagens_dir_path_default = ConstantsApp.getParametro("dir_path");
String flash_dir_path = ConstantsApp.getParametro("flashpath");
/*
System.out.println("***************************" );
System.out.println("imagens_dir_path" + imagens_dir_path);
System.out.println("imagens_dir_path_default" + imagens_dir_path_default);
System.out.println("flash_dir_path" + flash_dir_path);
*/
...
if ("InsertImage".equals(toDo) || "newfolder".equals(toDo) || "DeleteImage".equals(toDo) || "UploadImage".equals(toDo) ) {
...
//System.out.println("pasta === "+dir_path);
%>
...
<%
String pathToIncFiles = ConstantsApp.getParametro("pathToIncFiles");
System.out.println("pathToIncFiles:  " + pathToIncFiles);
